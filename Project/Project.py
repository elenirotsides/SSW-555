...
def eval():
    ...
    for line in lines:
        ...
        if tag == "DATE":
            ...
            """Checks that the marriage is valid, meaning, there is no bigamy. Marriage should not occur during marriage to another spouse."""
            if userStories.bigamy(families, id_, date) == True:
                print(
                    f"Error: US11: Individual: {id_}: Marriage should not occur during marriage to another spouse")
